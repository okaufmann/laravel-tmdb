 ...
 * @version 0.0.1
 */
namespace Okaufmann\LaravelTmdb\Model\Common\QueryParameter;

use Okaufmann\LaravelTmdb\Model\Common\QueryParameter\Type\CollectionToCommaSeperatedString;
