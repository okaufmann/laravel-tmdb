 ...
 * @version 0.0.1
 */
namespace Okaufmann\LaravelTmdb\Factory\Account;

use Okaufmann\LaravelTmdb\Exception\InvalidArgumentException;
use Okaufmann\LaravelTmdb\Factory\AbstractFactory;
use Okaufmann\LaravelTmdb\Model\Account\Avatar\Gravatar;
