...
use Okaufmann\LaravelTmdb\Common\ObjectHydrator;
use Okaufmann\LaravelTmdb\Event\HydrationEvent;
use Okaufmann\LaravelTmdb\Event\TmdbEvents;
...
use Okaufmann\LaravelTmdb\Model\Common\Rating;
...
abstract class AbstractFactory
{
    ...
    {
        return $this->hydrateSubject($subject, $data);
    }
     ...
     * @return AbstractModel
     */
    public function hydrateSubject($subject, $data)
    {
        $objectHydrator = new ObjectHydrator();

        return $objectHydrator->hydrate($subject, $data);
    }
}
